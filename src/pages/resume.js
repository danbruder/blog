      ...
      <div className="mw8 pa3 pa5-l center pv3 pv4-l ">
        <div className="mb5">
          ...
          <p className="lh-copy">
            ...
            coverage, reliable deployment, uptime, meeting budget and
            controlling scope, pragmatism and gumption.
          </p>
          <p className="lh-copy">
            I prefer demos over presentations, I like shipping MVPs quickly, and
            I like to celebrate clients' success together.
          </p>
          <p className="lh-copy i ">
            I'm available for contracts for web application development. I
            prefer Elixir/Phoenix and ReactJS, but am comfortable in a number of
          ...
          <div className="flex-ns bt bw1 pv1 mt4 b--black">
            ...
            <div className="pr3 pb3 pt0">
              <p className="lh-copy">
                I have 7 years professional software development experience - 5
                of which have been client facing as an application consultant.
              </p>
              ...
              <p className="lh-copy">
                I care <strong>deeply</strong> about my clients' success.
                Together we take steps to make sure we are building the{' '}
                <i>right</i> product - one that solves real world problems
                effectively.
              </p>
              <p className="lh-copy">
                Once we are working together, I communicate frequently and
                clearly, demoing progress along the way. I communicate risks and
                problems as soon as they arise. Open honest communication is
                best.
              </p>
              <p className="lh-copy">
            ...
            <div className="pr3 pb3 pt0 mt3">
              <div className="pb3">
                ...
                <label className="ttu gray f6 db pt1 flex items-center">
                  <Calendar
                    style={{ width: 14, height: 14, paddingRight: 4 }}
                  />{' '}
                  2017 - present
                  <MapPin
                    style={{
              ...
              <div className="pb3">
                ...
                <p className="lh-copy">
                  Worked with clients on a range of web applications. Promoted
                  to senior level part way through my time at RDG. Led a DevOps
              ...
              <div className="pb3">
                ...
                <p className="lh-copy pt0">
                  ...
                  software (C#), and reviewed assembly code for an airline
                  cockpit instrument.
                </p>
              </div>
            </div>
          ...
          <div className="flex-ns bt bw1 pv1 mt1 b--black">
            ...
            <div className="pr3 pb3 pt0 mt3">
              <div className="pb3">
                ...
                <p className="lh-copy">
                  Studied under industry experts in Electromagnetic
