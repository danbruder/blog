        ...
        <div className="mw9 center w-100 pa3 cf pa5-ns bg-light-gray">
          ...
          <div className="cf bt b--black-90 pv3">
            ...
            <div className="fl-ns fn w-50-ns w-100 ">
              ...
              <p className="lh-copy mt0 measure">
                Theres a little chat bubble in the lower corner of the page. If
                we're not here, leave an email address and we'll respond.
              </p>
            </div>
          </div>
          ...
          <div className="cf bt b--black-90 pv3">
            ...
            <div className="fl-ns fn w-50-ns w-100 ">
              ...
              <p className="lh-copy mt0 measure">
                We're headquartered in the suburbs of Grand Rapids, MI. Come by
          ...
          <div className="cf bt b--black-90 pv3">
            ...
            <div className="fl-ns fn w-50-ns w-100 ">
              <h2 className="mb0">That's it.</h2>
              <p className="lh-copy mt0 measure">
                We're nice people. We care about what we do and about our
                clients' success. If nothing else, just leave us a wave. 👋
              </p>
            </div>
          </div>
        </div>
