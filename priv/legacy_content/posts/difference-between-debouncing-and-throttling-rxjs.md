...
<div class="bg-white rounded-lg my-12 browser max-w-xl m-auto">
    ...
    <iframe src="/images/legacy/difference-between-debouncing-and-throttling-rxjs/debouncing.html" style="width:100%; height:200px; " class="rounded-b-lg border-l border-r border-b border-zinc-400"></iframe>
</div>
...
<div class="bg-white rounded-lg my-12 browser max-w-xl m-auto">
    ...
    <iframe src="/images/legacy/difference-between-debouncing-and-throttling-rxjs/throttling.html" style="width:100%; height:200px; " class="rounded-b-lg border-l border-r border-b border-zinc-400"></iframe>
</div>
